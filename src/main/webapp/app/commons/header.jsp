                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown profile">
                        <a href="javascript:void(0);" class="dropdown-toggle dropdown-hover" data-toggle="dropdown">
                            <span class="meta">
                                <span class="avatar"><img src="<%=request.getContextPath() %>/image/avatar/avatar.png" class="img-circle" alt="" /></span>
                                <span class="text hidden-xs hidden-sm pl5">Juan Francisco</span>
